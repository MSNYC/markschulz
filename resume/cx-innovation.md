...
highlights:
  - Founded and scaled BEACON AI enablement initiative from 25-user pilot to 500+ employees agency-wide
  - Pioneered custom GPT development for pharmaceutical brands, democratizing 15+ years of strategy insights
  - Built advanced analytics pipelines and automation solutions that transformed data into actionable CX insights
  - Led omnichannel experience planning for 9+ oncology brands, optimizing journeys across HCP and patient audiences
---

## Experience

### VP, Experience Planner
**Biolumina** (Omnicom) | New York, NY | Jan 2021 - Present

- Founded and led BEACON, Biolumina's enterprise-wide AI enablement initiative, scaling from a 25-user pilot to agency-wide adoption across 500+ employees
...
- Created advanced Google Analytics workflows including regression-based reconstruction of corrupted GA4 session data using server logs

### VP, Group Account Supervisor
**Harrison & Star** (Omnicom) | New York, NY | Jan 2020 - Jan 2021
...
**WebMD/Medscape** (Internet Brands) | New York, NY | Jan 2018 - Dec 2019
...
- Synthesized internal and external data (NRx/TRx, company forecasts, impressions, engagements) to continuously refine campaign execution
...
### Director, Commercial Clinical Strategy
**WebMD/Medscape** (Internet Brands) | New York, NY | Jan 2016 - Jan 2018
...
**Patients & Purpose** (Omnicom) | New York, NY | Jan 2015 - Dec 2016
...
**Pfizer** | New York, NY | Jan 2008 - Jan 2012
